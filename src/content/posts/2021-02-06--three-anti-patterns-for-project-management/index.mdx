...
import slowImage from './slow.jpg';
import threeTipsImage from './3-tips.png';
import tasksImage from './tasks.png';
import calendarImage from './calendar.png';
import ganttImage from './gantt.png';

<Image src={slowImage} alt="Slow-moving sloth representing slow project management" width={800} />
...
<Image src={threeTipsImage} alt="Three anti-patterns illustrated" width={400} class="img-50" />
...
<Image src={tasksImage} alt="Task list visualization" width={400} class="img-50" />
...
<Image src={calendarImage} alt="Calendar filled with meetings" width={400} class="img-50" />
...
<Image src={ganttImage} alt="Complex Gantt chart diagram" width={400} class="img-50" />
