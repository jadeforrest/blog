...
import processgatesImage from './process-gates.jpg';
import eternalgateImage from './eternal-gate.png';
import gateofslowingImage from './gate-of-slowing.png';
import deathspiralImage from './death-spiral.png';
import narrowgatesImage from './narrow-gates.png';
import alertautomationImage from './alert-automation.png';
import nongateImage from './non-gate.png';
import doittogetherImage from './do-it-together.png';
import learnfromfailureImage from './learn-from-failure.png';
...
<Image src={processgatesImage} alt="Process gates" width={800} />
...
<Image src={eternalgateImage} alt="Eternal gate" width={400} class="img-50" />
...
<Image src={gateofslowingImage} alt="Gate of slowing" width={400} class="img-50" />
...
<Image src={deathspiralImage} alt="Death spiral" width={400} class="img-50" />
...
<Image src={narrowgatesImage} alt="Narrow gates" width={400} class="img-50" />
...
<Image src={alertautomationImage} alt="Alert automation" width={320} class="img-40" />
...
<Image src={nongateImage} alt="Non gate" width={640} class="img-80" />
...
<Image src={doittogetherImage} alt="Do it together" width={400} class="img-50" />
...
<Image src={learnfromfailureImage} alt="Learn from failure" width={400} class="img-50" />
