...
import guideImage from './guide.jpg';
import workingsessionsImage from './working-sessions.png';
...
<Image src={guideImage} alt="Guide" width={800} />
...
<Image src={workingsessionsImage} alt="Working sessions" width={560} class="img-70" />
...
<Image src={moneyImage} alt="Money" width={120} class="img-15" />
