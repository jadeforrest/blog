...
import communicationImage from './communication.jpg';
import infoFlowUpImage from './info-flow-up.jpg';
import infoFlowAroundYouImage from './info-flow-around-you.jpg';
import infobitNotesImage from './infobit-notes.jpg';
import infobitsPeopleImage from './infobits-people.jpg';
import infobitsEditedImage from './infobits-edited.jpg';

<Image src={communicationImage} alt="Communication and information flow concept" width={800} />
...
<Image src={infoFlowUpImage} alt="Diagram showing information flowing upward to manager" width={400} class="img-50" />
...
<Image src={infoFlowAroundYouImage} alt="Diagram showing information flowing in multiple directions" width={400} class="img-50" />
...
<Image src={infobitNotesImage} alt="Example of infobit notes in a document" width={800} />
...
<Image src={infobitsPeopleImage} alt="Infobits organized by person's name" width={800} />

Then, I edit them based on that particular person's information needs:

<Image src={infobitsEditedImage} alt="Edited infobits tailored for each recipient" width={800} />
