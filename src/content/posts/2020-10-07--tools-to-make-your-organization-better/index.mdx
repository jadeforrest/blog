...
import hammerImage from './hammer.jpg';
import donutslacklogoImage from './donut-slack-logo.png';
import heytacologoImage from './heytacologo.png';
import fellowlogoImage from './fellow-logo.png';
import reclaimaiImage from './reclaimai.png';

<Image src={hammerImage} alt="Hammer" width={800} />
...
<Image src={donutslacklogoImage} alt="Donut slack logo" width={800} />
...
<Image src={heytacologoImage} alt="Heytacologo" width={800} />
...
<Image src={fellowlogoImage} alt="Fellow logo" width={800} />
...
<Image src={reclaimaiImage} alt="Reclaimai" width={800} />

[ReclaimAI](https://go.reclaim.ai/89i1sugn123m) is a tool to make your calendar more productive. It has a number of really useful tools to help you:
