...
import productstrategyImage from './product-strategy.jpg';
import strategysoonImage from './strategy-soon.png';
import roadmapaintstrategyImage from './roadmap-aint-strategy.png';
import directcompetitionImage from './direct-competition.png';
import futurethinkingImage from './future-thinking.png';
import oppositetestImage from './opposite-test.png';
import executionplanImage from './execution-plan.png';
...
<Image src={productstrategyImage} alt="Product strategy" width={800} />
...
<Image src={strategysoonImage} alt="Strategy soon" width={560} class="img-70" />
...
<Image src={roadmapaintstrategyImage} alt="Roadmap aint strategy" width={240} class="img-30" />
...
<Image src={directcompetitionImage} alt="Direct competition" width={400} class="img-50" />
...
<Image src={futurethinkingImage} alt="Future thinking" width={400} class="img-50" />
...
<Image src={oppositetestImage} alt="Opposite test" width={400} class="img-50" />
...
<Image src={executionplanImage} alt="Execution plan" width={320} class="img-40" />
