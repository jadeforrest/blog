...
import reflectionImage from './reflection.jpg';
import bouncingImage from './bouncing.png';
import directindirectactionsImage from './direct-indirect-actions.png';
...
<Image src={reflectionImage} alt="Reflection" width={800} />
...
<Image src={bouncingImage} alt="Bouncing" width={400} class="img-50" />
...
<Image src={directindirectactionsImage} alt="Direct indirect actions" width={400} class="img-50" />
