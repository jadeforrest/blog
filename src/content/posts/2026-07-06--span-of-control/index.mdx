...
tags: ["ai", "architecture", "complexity", "org-design", "platform-engineering", "scaling"]
cover: ./span.jpg
author: Jade Rubick
discussionId: "span-of-control"
description: "Understand the tradeoffs of team size and span of control for managers"
kitEditUrls: "https://app.kit.com/sequences/1031459"
kitSyncHash: "25db15c90bc878545722d0c4332f8d25"
---

import { Image } from 'astro:assets';
import spanImage from './span.jpg';
...
<Image src={spanImage} alt="An image of a span of a bridge" width={800} />
...
<style>{`
  .soc-table { border-collapse: collapse; }
  .soc-table td { border: 1px solid #555; padding: 12px 16px; }
`}</style>

<table class="soc-table">
  <tr>
   <td style="background-color:#d6e4f5">Layers</td>
   <td style="background-color:#d9d2e9">3 direct reports</td>
   <td style="background-color:#d9d2e9">5 direct reports</td>
   <td style="background-color:#d9d2e9">8 direct reports</td>
   <td style="background-color:#d9d2e9">10 direct reports</td>
   <td style="background-color:#d9d2e9">12 direct reports</td>
   <td style="background-color:#d9d2e9">15 direct reports</td>
   <td style="background-color:#d9d2e9">20 direct reports</td>
  </tr>
  <tr>
   <td style="background-color:#d6e4f5">2</td>
   <td style="background-color:#fdf6d3">4</td>
   <td style="background-color:#fdf6d3">6</td>
   <td style="background-color:#fdf6d3">9</td>
   <td style="background-color:#fdf6d3">11</td>
   <td style="background-color:#fdf6d3">13</td>
   <td style="background-color:#fdf6d3">16</td>
   <td style="background-color:#fdf6d3">21</td>
  </tr>
  <tr>
   <td style="background-color:#d6e4f5">3</td>
   <td style="background-color:#fdf6d3">13</td>
   <td style="background-color:#fdf6d3">31</td>
   <td style="background-color:#fdf6d3">73</td>
   <td style="background-color:#fdf6d3">111</td>
   <td style="background-color:#fdf6d3">157</td>
   <td style="background-color:#fdf6d3">241</td>
   <td style="background-color:#fdf6d3">421</td>
  </tr>
  <tr>
   <td style="background-color:#d6e4f5">4</td>
   <td style="background-color:#fdf6d3">40</td>
   <td style="background-color:#fdf6d3">156</td>
   <td style="background-color:#fdf6d3">585</td>
   <td style="background-color:#fdf6d3">1,111</td>
   <td style="background-color:#fdf6d3">1,885</td>
   <td style="background-color:#fdf6d3">3,616</td>
   <td style="background-color:#fdf6d3">8,421</td>
  </tr>
  <tr>
   <td style="background-color:#d6e4f5">5</td>
   <td style="background-color:#fdf6d3">121</td>
   <td style="background-color:#fdf6d3">781</td>
   <td style="background-color:#fdf6d3">4,681</td>
   <td style="background-color:#fdf6d3">11,111</td>
   <td style="background-color:#fdf6d3">22,621</td>
   <td style="background-color:#fdf6d3">54,241</td>
   <td style="background-color:#fdf6d3">168,421</td>
  </tr>
  <tr>
   <td style="background-color:#d6e4f5">6</td>
   <td style="background-color:#fdf6d3">364</td>
   <td style="background-color:#fdf6d3">3,906</td>
   <td style="background-color:#fdf6d3">37,449</td>
   <td style="background-color:#fdf6d3">111,111</td>
   <td style="background-color:#fdf6d3">271,453</td>
   <td style="background-color:#fdf6d3">813,616</td>
   <td style="background-color:#fdf6d3">3,368,421</td>
  </tr>
</table>
...
![alt_text](lines-of-communication-stackoverflow-1024x953.png "image_tooltip")
...
Thank you to all the people who have shaped my thinking on this as I’ve discussed it recently. I’d like to particularly thank [Nic Benders](https://www.linkedin.com/in/benders/), my old office mate. Thank you to [Anton Vaynshtok](https://www.linkedin.com/in/avaynshtok/) for introducing me to the [Tyranny of Structurelessness](https://www.jofreeman.com/joreen/tyranny.htm). And thank you to [Ken Liu](https://www.linkedin.com/in/kenliu2/) for making some points that influenced my thinking about team size and how it relates to span of control. 

Image by <a href="https://pixabay.com/users/memorycatcher-168384/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2415293">Siggy Nowak</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2415293">Pixabay</a>