...
import hiringfastImage from './hiring-fast.jpg';
import applytoofferImage from './apply-to-offer.png';
import sla24hrImage from './24-hr-sla.png';
import morestepsImage from './more-steps.png';
import lessstepsImage from './less-steps.png';
import interviewtimeImage from './interview-time.png';
import fairinterviewImage from './fair-interview.png';

<Image src={hiringfastImage} alt="Hiring fast" width={800} />
...
<Image src={applytoofferImage} alt="Apply to offer" width={400} class="img-50" />
...
<Image src={sla24hrImage} alt="24 hr sla" width={400} class="img-50" />
...
<Image src={morestepsImage} alt="More steps" width={800} />
...
<Image src={lessstepsImage} alt="Less steps" width={800} />
...
<Image src={interviewtimeImage} alt="Interview time" width={400} class="img-50" />
...
<Image src={fairinterviewImage} alt="Fair interview" width={560} class="img-70" />
