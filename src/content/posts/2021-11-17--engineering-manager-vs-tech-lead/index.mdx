...
import managerImage from './manager.jpg';

<Image src={managerImage} alt="Manager" width={800} />
...
<table border="1" cellpadding="5" cellspacing="0">
  ...
  <tr>
   <td></td>
   <td>Engineering Manager (EM) does projects</td>
   <td>Product Manager (PM) does projects</td>
   <td>Tech lead (TL)</td>
  ...
  <tr>
   ...
   <td>PM</td>
   <td>STO or PM</td>
   <td>Product owner (poorly)</td>
  </tr>
  <tr>
   <th>Talk with customers</th>
   <td>PM</td>
   <td>PM (poorly)</td>
   <td>PM</td>
   <td>STO or PM</td>
  ...
  <tr>
   <th></th>
   <th colspan="5">Reporting</th>
  </tr>
  <tr>
   <th></th>
   <td>Engineers report to EM.</td>
   <td>Engineers report to EM.</td>
   <td>Engineers report to TL.</td>
   <td>Everyone (engineers, PM, TL) reports to STO.</td>
   <td>Unspecified. Usually Engineers report to EM.</td>
  </tr>
</table>
