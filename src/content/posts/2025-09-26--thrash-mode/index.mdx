...
import thrashImage from './thrash.jpg';
...
<Image src={thrashImage} alt="Thrash" width={800} />
...
My current tooling of choice is [Reclaim](https://go.reclaim.ai/89i1sugn123m) + Todoist. I don't particularly care for Todoist, but use it because of its Reclaim integration.
...
I share this because I find it useful, but you may be able to find other tools that do the same thing. If you do look into Reclaim, please use my link for it: [Reclaim](https://go.reclaim.ai/89i1sugn123m)
