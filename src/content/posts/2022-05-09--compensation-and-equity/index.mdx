...
kitEditUrls: "https://app.kit.com/sequences/1059035"
kitSyncHash: "b18f059314c743579e855f8c00f35eea"
---

import { Image } from 'astro:assets';
import compImage from './comp.jpg';
import geoblindImage from './geo-blind.png';
import geobalancedImage from './geo-balanced.png';
import geoadjustmentImage from './geo-adjustment.png';
import levelsnotequalImage from './levels-not-equal.png';
...
<Image src={compImage} alt="Comp" width={800} />
...
<Image src={geoblindImage} alt="Geo blind" width={400} class="img-50" />
...
<Image src={geobalancedImage} alt="Geo balanced" width={400} class="img-50" />
...
<Image src={geoadjustmentImage} alt="Geo adjustment" width={400} class="img-50" />
...
People tend to be pretty ideological about which of these is best. But the important thing is you need to understand how it works at your company. According to Carta, [86% of US startups adjust compensation by location](https://info.carta.com/rs/214-BTD-103/images/State-of-Startups-2025.pdf?version=1).
...
<Image src={levelsnotequalImage} alt="Levels not equal" width={400} class="img-50" />
