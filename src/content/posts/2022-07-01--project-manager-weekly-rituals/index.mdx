...
import projectmanagementImage from './project-management.jpg';
import milestoneyesreallyImage from './milestone-yes-really.png';
import projectplanImage from './project-plan.png';
import riskregistryImage from './risk-registry.png';
import aaronbermantweetImage from './aaron-berman-tweet.png';
...
<Image src={projectmanagementImage} alt="Project management" width={800} />
...
<Image src={milestoneyesreallyImage} alt="Milestone yes really" width={240} class="img-30" />
...
<Image src={projectplanImage} alt="Project plan" width={400} class="img-50" />
...
<Image src={riskregistryImage} alt="Risk registry" width={400} class="img-50" />
...
<Image src={aaronbermantweetImage} alt="Aaron berman tweet" width={480} class="img-60" />
