---
title: Yes you can measure engineering
tags: ["ai", "metrics", "prioritization"]
cover: ./numbers.jpg
author: Jade Rubick
discussionId: "valuesum-metric"
description: "Jade shares how he likes to measure the value delivery of engineering organizations using the ValueSum metric."
kitEditUrls: "https://app.kit.com/sequences/1031459"
kitSyncHash: "22adbfcaafe48828e4e4a012a4f5ec14"
---

import { Image } from 'astro:assets';
import numbersImage from './numbers.jpg';
...
<Image src={numbersImage} alt="Many numbers on a table" width={800} />
...
<table style="border:1px black solid; border-spacing:15px; ">
  <tr style="text-align:left;">
   <th>Deliverable</th>
   <th>Score</th>
  </tr>
  <tr>
   <td>New pricing tool</td>
   <td>6</td>
  </tr>
  <tr>
   <td>Automatic invoice generation</td>
   <td>8</td>
  </tr>
  <tr>
   <td>Foreign currency support</td>
   <td>3</td>
  </tr>
  <tr style="text-align:left;">
   <th>ValueSum for time period</th>
...
It’s okay if we score it wrong. In three or six months, we can reevaluate. Of course, there is a bias against recognizing the value of *this type* of work in the future, because if successful, those problems will be invisible. But we can look at the churn rates and discuss it, and see if we think it was as valuable as we thought.
...
!["Chart showing value delivered over time"](valuesum-chart.png "image_tooltip")
...
“Velocity” measures how complicated you *thought* the work was. It’s a sum of your estimates, that you’ve completed.
