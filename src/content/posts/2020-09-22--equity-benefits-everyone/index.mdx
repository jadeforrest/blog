...
import equityImage from './equity.jpg';
import washingMachineImage from './washing-machine.png';

<Image src={equityImage} alt="Equity concept illustration" width={800} />
...
<Image src={washingMachineImage} alt="Washing machine with large, easy-to-read controls" width={400} class="img-50" />
