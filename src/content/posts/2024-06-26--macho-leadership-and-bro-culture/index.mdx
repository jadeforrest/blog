...
import machoImage from './macho.jpg';
import listenupImage from './listen-up.png';
...
<Image src={machoImage} alt="Macho" width={800} />
...
<Image src={listenupImage} alt="Listen up" width={600} class="img-75" />
