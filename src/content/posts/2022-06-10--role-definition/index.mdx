...
import roledefinitionImage from './role-definition.jpg';
import threecolumnsImage from './three-columns.png';
import threecolumnsfilledImage from './three-columns-filled.png';
import emImage from './em.png';

<Image src={roledefinitionImage} alt="Role definition" width={800} />
...
<Image src={threecolumnsImage} alt="Three columns" width={400} class="img-50" />
...
<Image src={threecolumnsfilledImage} alt="Three columns filled" width={400} class="img-50" />
...
<Image src={emImage} alt="Em" width={400} class="img-50" />
