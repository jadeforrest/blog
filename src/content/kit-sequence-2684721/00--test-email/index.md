...
sendDays:
  ...
  - saturday
  - sunday
emailTemplateId: 1293674
---
Share this link: [https://www.rubick.com/innovation-labs/](https://www.rubick.com/innovation-labs/)​

Today we cover the topic of creating an Innovation Lab.

![Picture of laboratory](https://www.rubick.com/innovation-labs/labs.jpg)
...
But sometimes this exploration is _between_ Product and Engineering. For example, is this even technically possible? Or is there a product possibility here that can be built in an economical way? Are there novel approaches we can take that we don’t even know are possible right now?
...
But it can also confuse if it’s not fully agreed upon as the direction. Often its desirable to have a lot of these possible prototypes. They should be clearly communicated as _possibilities_ until you get alignment that they are the way forward.
...
I believe the work McKinsey based the Three Horizon model on was The Alchemy of Growth, by Mehrdad Baghai, Stephen Coley, and David White. The Podcast for the Three Horizon Model is [here](https://www.mckinsey.com/capabilities/strategy-and-corporate-finance/our-insights/enduring-ideas-the-three-horizons-of-growth#). My brain trust on Innovation Lab folks is [Jim Ruppert](https://www.linkedin.com/in/jim-ruppert-0ba71/) and [Jacob Groundwater](https://www.linkedin.com/in/groundwater/). Jacob reviewed the post, and Jim provided a ton of useful insight, several points which became sections in this article. Thanks to [Sam Alexander](https://www.linkedin.com/in/sxalexander/) for helping me find and digest the podcast on the Three Horizon Model. [Tim Krajcar](https://www.linkedin.com/in/timkrajcar/) provided some valuable suggestions and feedback, especially around handsoffs and failure modes. [Karl Schmidt](https://www.linkedin.com/in/kschmidtdev/) emphasized the importance of throwing away your prototypes. [Susie Dirks](https://www.linkedin.com/in/susiedirks/) helped me fill in the section on the connection with engineering and morale issues.

Image by [PublicDomainPictures](https://pixabay.com/users/publicdomainpictures-14/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=217041) from [Pixabay](https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=217041)​
